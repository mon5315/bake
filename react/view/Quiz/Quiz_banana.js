            ...
            <SafeAreaView style={styles.container}>
                ...
                <Modal
                    ...
                    onRequestClose={() => {
                        ...
                        if (correct) {
                            ...
                            navigation.replace('Quiz_banana');
                        }
                    }}
                >
                    <Quiz_ox
                ...
                <View style={styles.content}>
                    <View style={styles.area_quiz_abc}>
                        ...
                        />
                        <Text style={styles.txt_quiz}>과일의 이름을 맞춰보세요.</Text>

                        <ImageButton
                            style={styles.img_a}
                            source={require('../../../assets/images/imgBanana.png')}
                            resizeMode={'contain'}
                            onPress={() => {
                                Tts.speak('Banana');
                            }}
                        />
                        <Text style={styles.txt_hint}>힌트가 필요하면 과일을 눌러봐요!</Text>
